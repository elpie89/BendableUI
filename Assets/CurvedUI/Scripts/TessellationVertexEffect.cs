...
public class TessellationVertexEffect : BaseMeshEffect
{
    ...
    public override void ModifyMesh(VertexHelper verts)
    {
        ...
        // Tessellate
        int startingVertexCount = verts.currentVertCount;
    ...
    //void TessellateQuad(VertexHelper verts, int vertexIndex)
    //{
